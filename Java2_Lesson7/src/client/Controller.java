...
public class Controller implements Initializable {
    ...
    public void setAuthenticated(boolean authenticated) {
        ...
        clientsList.setOrientation(Orientation.HORIZONTAL);
        if (!authenticated) {
            nickname = "";
        }
    ...
    public void updateClientsList(String[] client) {
        clients = FXCollections.observableArrayList(client);
        clientsList = new ListView<>(clients.sorted());
